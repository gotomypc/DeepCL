...
reset to the first batch, and set epoch\-Done to false 
...
if most recent epoch has finished, then resets, and starts a new set of learning \begin{DoxyParagraph}{Public A\-P\-I}
